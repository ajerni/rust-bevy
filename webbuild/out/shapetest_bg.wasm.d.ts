...
export function wasm_bindgen__convert__closures__invoke0_mut__h07ef982d6c9ef1d0(a: number, b: number): void;
export function wasm_bindgen__convert__closures__invoke1_mut__h0c5f7f3d10e3cac3(a: number, b: number, c: number): void;
export function wasm_bindgen__convert__closures__invoke2_mut__h1930b02bc1cf56d1(a: number, b: number, c: number, d: number): void;
